...
let { SignUpValidator, LoginValidator, UpdateUserValidator, validate } = require('../utils/validator');
...
router.put('/update', check_authentication, UpdateUserValidator, validate, async function (req, res, next) {
    try {
        let user = req.user;  
